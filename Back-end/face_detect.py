...
# Iniciar la captura de video desde el archivo o cámara
...
cv2.namedWindow('Detección de Rostros y Rasgos Faciales', cv2.WINDOW_NORMAL)
        ...
        for box in detections:
            ...
            try:
                ...
                if len(face_encodings) > 0:
                    ...
                    matches = face_recognition.compare_faces(known_encodings, face_encoding,tolerance=1)
                    name = "Desconocido"
